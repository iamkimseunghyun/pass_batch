package io.laaf.passbatch.job.pass;

import io.laaf.passbatch.repository.pass.*;
import io.laaf.passbatch.repository.user.UserGroupMappingEntity;
import io.laaf.passbatch.repository.user.UserGroupMappingRepository;
...
public class AddPassesTaskletTest {
    ...
    public void test_execute() {
        ...
        var passEntitiesCaptor = ArgumentCaptor.forClass(List.class);
